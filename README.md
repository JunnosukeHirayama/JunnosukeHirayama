...
### 自己紹介
東京理科大学創域理工学研究科数理科学専攻の修士課程で解析学を専攻しています。大学院での研究は画像生成AIの拡散モデルについて数理的な視点で研究を行う予定です。プログラミング関係では大学での数値解析や、趣味でのアプリ開発などを行っています。今後も引き続き様々なシステムを作り、理論的な深掘りと、それを形にする実装力の両立を目指しています。
