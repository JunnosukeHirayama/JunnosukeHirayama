...
### 自己紹介
東京理科大学創域理工学研究科数理科学専攻の修士課程で解析学を専攻しています。大学院での研究は画像生成AIの拡散モデルについて数理的な視点で研究を行う予定です。プログラミング関係では大学での数値解析や、趣味でのアプリ開発などを行っています。まだ扱っていないGoやRustなども今後は勉強し、引き続き様々なシステムを作り、理論的な深掘りとそれを形にする実装力の両立を目指しています。

---
##  About Me

- **Education:** 東京理科大学大学院 創域理工学研究科 数理科学専攻 修士1年（偏微分方程式、解析学）
- **Background:** 以前の長期インターンシップではAI関係WEBメディアにおけるSEO業務のプロジェクトリーダー経験などがあります。
...
- **Web & UI Development:** Google Apps Script (GAS), Tkinter, MySQL
